...
<div class="container">
    <div class="modal fade in" id="importShoemart">
    <div class="modal-dialog">
    <div class="modal-content" style="width:400px;">
            <div class="modal-header" style="background-color:#455357; color:white;">
                <h3 class="modal-title">IMPORT SHOEMART FILE</h3>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body" style="background-color: white;">                  
                <form action="{{route('Customer.importShoemart')}}" method="post" enctype="multipart/form-data">  
                    @csrf               
