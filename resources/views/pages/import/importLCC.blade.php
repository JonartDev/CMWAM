<div class="container">
    <div class="modal fade in" id="importLCC">
    <div class="modal-dialog">
    <div class="modal-content" style="width:400px;">
            <div class="modal-header" style="background-color:#455357; color:white;">
                <h3 class="modal-title">IMPORT LCC FILE</h3>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body" style="background-color: white;">                  
                <form action="{{route('Customer.importLCC')}}" method="post" enctype="multipart/form-data">  
                    @csrf               
                    ...
                    <div class="form-group col-md-11">
                    <button id="LCC" type="submit" class="btn btn-xs btn-dark submit float-right" style="font-size:14px; width:150px; height:40px;" name="upload">
                    UPLOAD</button>  
                </div> 
                </form>                     
            </div>        
